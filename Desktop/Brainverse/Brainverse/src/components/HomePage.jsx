            ...
            <div className="relative z-20">
              ...
              <div className="mt-12 bg-gray-800 bg-opacity-30 p-4 rounded-lg border border-gray-700 border-opacity-50 relative z-20">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-gray-300">Trusted by <span className="font-bold text-blue-400">1000+</span> students</p>
                    <div className="flex mt-1">
                      ...
                      <span className="text-xs ml-1 text-gray-400">4/5</span>
                    </div>
                  </div>
                </div>
              </div>
